...
const querystring = require('querystring');
 ...
 /**
     ...
     */
const _ = require('lodash'); //to flatten arrays 
const cheerio = require('cheerio'); //to load html from megabus site 
const fetch = require('node-fetch'); //to make GET request to megabus site 
...
class TicketFinder {
  ...
  /**
     ...
     * @param {Route} route - Route to search for
